...
public class EncoderValidator {
	...
	public boolean isValidated(String jsonString, JSONEncoder testee) throws Exception{
		String s0 = null;
		String s = null;
	 ...
	 * @param jsonString
	 * @param testee
	 * @param enableSimple If check testee with JSON.simple in addition to JSON RI library.
	 * @return
	 * @throws Exception
	 */
	public boolean isValidated(String jsonString, JSONEncoder testee, boolean enableSimple) throws Exception{
		...
		String resultString = testee.toJSONString(metaGraph);
		s = simpleEncoder.toJSONString(simpleDecoder.fromJSONString(resultString));
